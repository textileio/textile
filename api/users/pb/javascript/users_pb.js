...
goog.exportSymbol('proto.users.pb.ListThreadsReply.Thread', null, global);
 ...
 * @constructor
 */
proto.users.pb.ListThreadsReply.Thread = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.users.pb.ListThreadsReply.Thread, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  /**
   * @public
   * @override
   */
  proto.users.pb.ListThreadsReply.Thread.displayName = 'proto.users.pb.ListThreadsReply.Thread';
}
...
proto.users.pb.ListThreadsReply.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.users.pb.ListThreadsReply.Thread.toObject, includeInstance)
  };
...
proto.users.pb.ListThreadsReply.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.users.pb.ListThreadsReply.Thread;
      reader.readMessage(value,proto.users.pb.ListThreadsReply.Thread.deserializeBinaryFromReader);
      msg.addList(value);
      break;
    default:
      reader.skipField();
...
proto.users.pb.ListThreadsReply.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.users.pb.ListThreadsReply.Thread.serializeBinaryToWriter
    );
  }
};
 ...
 * @return {!Object}
 */
proto.users.pb.ListThreadsReply.Thread.prototype.toObject = function(opt_includeInstance) {
  return proto.users.pb.ListThreadsReply.Thread.toObject(opt_includeInstance, this);
};
 ...
 *     the JSPB instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.users.pb.ListThreadsReply.Thread} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.users.pb.ListThreadsReply.Thread.toObject = function(includeInstance, msg) {
  var f, obj = {
    id: msg.getId_asB64(),
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.users.pb.ListThreadsReply.Thread}
 */
proto.users.pb.ListThreadsReply.Thread.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.users.pb.ListThreadsReply.Thread;
  return proto.users.pb.ListThreadsReply.Thread.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.users.pb.ListThreadsReply.Thread} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.users.pb.ListThreadsReply.Thread}
 */
proto.users.pb.ListThreadsReply.Thread.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.users.pb.ListThreadsReply.Thread.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.users.pb.ListThreadsReply.Thread.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.users.pb.ListThreadsReply.Thread} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.users.pb.ListThreadsReply.Thread.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 */
proto.users.pb.ListThreadsReply.Thread.prototype.getId = function() {
 ...
 * @return {string}
 */
proto.users.pb.ListThreadsReply.Thread.prototype.getId_asB64 = function() {
 ...
 * @return {!Uint8Array}
 */
proto.users.pb.ListThreadsReply.Thread.prototype.getId_asU8 = function() {
 ...
 * @return {!proto.users.pb.ListThreadsReply.Thread} returns this
 */
proto.users.pb.ListThreadsReply.Thread.prototype.setId = function(value) {
 ...
 * @return {string}
 */
proto.users.pb.ListThreadsReply.Thread.prototype.getName = function() {
 ...
 * @return {!proto.users.pb.ListThreadsReply.Thread} returns this
 */
proto.users.pb.ListThreadsReply.Thread.prototype.setName = function(value) {
 ...
 * @return {!Array<!proto.users.pb.ListThreadsReply.Thread>}
 */
proto.users.pb.ListThreadsReply.prototype.getListList = function() {
  return /** @type{!Array<!proto.users.pb.ListThreadsReply.Thread>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.users.pb.ListThreadsReply.Thread, 1));
};


/**
 * @param {!Array<!proto.users.pb.ListThreadsReply.Thread>} value
...
/**
 * @param {!proto.users.pb.ListThreadsReply.Thread=} opt_value
 * @param {number=} opt_index
 * @return {!proto.users.pb.ListThreadsReply.Thread}
 */
proto.users.pb.ListThreadsReply.prototype.addList = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.users.pb.ListThreadsReply.Thread, opt_index);
};
