...
func (x *SummaryRequest) GetSince() *timestamp.Timestamp {
	if x != nil {
		return x.Since
	}
	return nil
...
type SummaryResponse struct {
	...
	AvgNanoFilSent   float32 `protobuf:"fixed32,9,opt,name=avg_nano_fil_sent,json=avgNanoFilSent,proto3" json:"avg_nano_fil_sent,omitempty"`
...
func (x *SummaryResponse) GetAvgNanoFilSent() float32 {
	if x != nil {
...
var file_api_sendfild_pb_sendfil_proto_rawDesc = []byte{
	...
	0x65, 0x12, 0x32, 0x0a, 0x06, 0x62, 0x65, 0x66, 0x6f, 0x72, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28,
	...
	0x28, 0x02, 0x52, 0x0e, 0x61, 0x76, 0x67, 0x4e, 0x61, 0x6e, 0x6f, 0x46, 0x69, 0x6c, 0x53, 0x65,
...
var file_api_sendfild_pb_sendfil_proto_depIdxs = []int32{
	...
	11, // 12: api.sendfild.pb.SummaryRequest.since:type_name -> google.protobuf.Timestamp
