...
var file_api_bucketsd_pb_bucketsd_proto_rawDesc = []byte{
	...
	0x55, 0x43, 0x43, 0x45, 0x53, 0x53, 0x10, 0x05, 0x32, 0xc9, 0x0d, 0x0a, 0x0a, 0x41, 0x50, 0x49,
...
var file_api_bucketsd_pb_bucketsd_proto_depIdxs = []int32{
	...
	49, // 12: api.bucketsd.pb.PushPathResponse.event:type_name -> api.bucketsd.pb.PushPathResponse.Event
	...
	33, // 19: api.bucketsd.pb.DefaultArchiveConfigResponse.archive_config:type_name -> api.bucketsd.pb.ArchiveConfig
	33, // 20: api.bucketsd.pb.SetDefaultArchiveConfigRequest.archive_config:type_name -> api.bucketsd.pb.ArchiveConfig
	33, // 21: api.bucketsd.pb.ArchiveRequest.archive_config:type_name -> api.bucketsd.pb.ArchiveConfig
	34, // 22: api.bucketsd.pb.ArchivesResponse.current:type_name -> api.bucketsd.pb.Archive
	34, // 23: api.bucketsd.pb.ArchivesResponse.history:type_name -> api.bucketsd.pb.Archive
	0,  // 24: api.bucketsd.pb.Metadata.RolesEntry.value:type_name -> api.bucketsd.pb.PathAccessRole
	3,  // 25: api.bucketsd.pb.PushPathResponse.Event.root:type_name -> api.bucketsd.pb.Root
	0,  // 26: api.bucketsd.pb.PushPathAccessRolesRequest.RolesEntry.value:type_name -> api.bucketsd.pb.PathAccessRole
	0,  // 27: api.bucketsd.pb.PullPathAccessRolesResponse.RolesEntry.value:type_name -> api.bucketsd.pb.PathAccessRole
	4,  // 28: api.bucketsd.pb.APIService.List:input_type -> api.bucketsd.pb.ListRequest
	6,  // 29: api.bucketsd.pb.APIService.Create:input_type -> api.bucketsd.pb.CreateRequest
	8,  // 30: api.bucketsd.pb.APIService.Root:input_type -> api.bucketsd.pb.RootRequest
	10, // 31: api.bucketsd.pb.APIService.Links:input_type -> api.bucketsd.pb.LinksRequest
	12, // 32: api.bucketsd.pb.APIService.ListPath:input_type -> api.bucketsd.pb.ListPathRequest
	15, // 33: api.bucketsd.pb.APIService.ListIpfsPath:input_type -> api.bucketsd.pb.ListIpfsPathRequest
	17, // 34: api.bucketsd.pb.APIService.PushPath:input_type -> api.bucketsd.pb.PushPathRequest
	19, // 35: api.bucketsd.pb.APIService.PullPath:input_type -> api.bucketsd.pb.PullPathRequest
	21, // 36: api.bucketsd.pb.APIService.PullIpfsPath:input_type -> api.bucketsd.pb.PullIpfsPathRequest
	23, // 37: api.bucketsd.pb.APIService.SetPath:input_type -> api.bucketsd.pb.SetPathRequest
	25, // 38: api.bucketsd.pb.APIService.Remove:input_type -> api.bucketsd.pb.RemoveRequest
	27, // 39: api.bucketsd.pb.APIService.RemovePath:input_type -> api.bucketsd.pb.RemovePathRequest
	29, // 40: api.bucketsd.pb.APIService.PushPathAccessRoles:input_type -> api.bucketsd.pb.PushPathAccessRolesRequest
	31, // 41: api.bucketsd.pb.APIService.PullPathAccessRoles:input_type -> api.bucketsd.pb.PullPathAccessRolesRequest
	37, // 42: api.bucketsd.pb.APIService.DefaultArchiveConfig:input_type -> api.bucketsd.pb.DefaultArchiveConfigRequest
	...
	9,  // 49: api.bucketsd.pb.APIService.Root:output_type -> api.bucketsd.pb.RootResponse
	11, // 50: api.bucketsd.pb.APIService.Links:output_type -> api.bucketsd.pb.LinksResponse
	13, // 51: api.bucketsd.pb.APIService.ListPath:output_type -> api.bucketsd.pb.ListPathResponse
	16, // 52: api.bucketsd.pb.APIService.ListIpfsPath:output_type -> api.bucketsd.pb.ListIpfsPathResponse
	18, // 53: api.bucketsd.pb.APIService.PushPath:output_type -> api.bucketsd.pb.PushPathResponse
	20, // 54: api.bucketsd.pb.APIService.PullPath:output_type -> api.bucketsd.pb.PullPathResponse
	22, // 55: api.bucketsd.pb.APIService.PullIpfsPath:output_type -> api.bucketsd.pb.PullIpfsPathResponse
	24, // 56: api.bucketsd.pb.APIService.SetPath:output_type -> api.bucketsd.pb.SetPathResponse
	26, // 57: api.bucketsd.pb.APIService.Remove:output_type -> api.bucketsd.pb.RemoveResponse
	...
	44, // 64: api.bucketsd.pb.APIService.Archives:output_type -> api.bucketsd.pb.ArchivesResponse
	46, // 65: api.bucketsd.pb.APIService.ArchiveWatch:output_type -> api.bucketsd.pb.ArchiveWatchResponse
