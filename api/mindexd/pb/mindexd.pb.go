...
type CalculateDealPriceResponse struct {
	...
	TotalCost         string `protobuf:"bytes,1,opt,name=total_cost,json=totalCost,proto3" json:"total_cost,omitempty"`
	VerifiedTotalCost string `protobuf:"bytes,2,opt,name=verified_total_cost,json=verifiedTotalCost,proto3" json:"verified_total_cost,omitempty"`
...
func (x *CalculateDealPriceResponse) GetTotalCost() string {
	if x != nil {
		return x.TotalCost
	}
	return ""
...
func (x *CalculateDealPriceResponse) GetVerifiedTotalCost() string {
	if x != nil {
...
var file_api_mindexd_pb_mindexd_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6c, 0x5f, 0x63, 0x6f, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x09,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x11, 0x76, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64,
