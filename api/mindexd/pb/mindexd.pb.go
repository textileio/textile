...
type CalculateDealPriceResponse struct {
	...
	PaddedSize        uint64 `protobuf:"varint,3,opt,name=padded_size,json=paddedSize,proto3" json:"padded_size,omitempty"`
	DurationEpochs    uint64 `protobuf:"varint,4,opt,name=duration_epochs,json=durationEpochs,proto3" json:"duration_epochs,omitempty"`
}
...
func (x *CalculateDealPriceResponse) GetPaddedSize() uint64 {
	if x != nil {
		return x.PaddedSize
	}
	return 0
...
func (x *CalculateDealPriceResponse) GetDurationEpochs() uint64 {
	if x != nil {
...
var file_api_mindexd_pb_mindexd_proto_rawDesc = []byte{
	...
	0x74, 0x61, 0x6c, 0x5f, 0x63, 0x6f, 0x73, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09,
	...
	0x18, 0x02, 0x20, 0x01, 0x28, 0x04, 0x52, 0x11, 0x76, 0x65, 0x72, 0x69, 0x66, 0x69, 0x65, 0x64,
	0x54, 0x6f, 0x74, 0x61, 0x6c, 0x43, 0x6f, 0x73, 0x74, 0x12, 0x1f, 0x0a, 0x0b, 0x70, 0x61, 0x64,
	0x64, 0x65, 0x64, 0x5f, 0x73, 0x69, 0x7a, 0x65, 0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x0a,
	...
	0x01, 0x28, 0x04, 0x52, 0x0e, 0x64, 0x75, 0x72, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x45, 0x70, 0x6f,
