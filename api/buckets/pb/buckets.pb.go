...
type InitReply struct {
	...
	WWW                  string   `protobuf:"bytes,3,opt,name=WWW,proto3" json:"WWW,omitempty"`
	IPNS                 string   `protobuf:"bytes,4,opt,name=IPNS,proto3" json:"IPNS,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *InitReply) GetURL() string {
	if m != nil {
		return m.URL
	}
	return ""
...
func (m *InitReply) GetWWW() string {
	if m != nil {
		return m.WWW
	}
	return ""
...
func (m *InitReply) GetIPNS() string {
	if m != nil {
		return m.IPNS
	}
	return ""
...
var fileDescriptor_95035767e889ecda = []byte{
	...
	,
}
