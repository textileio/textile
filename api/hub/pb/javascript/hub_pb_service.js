...
API.GetPrimaryThread = {
  methodName: "GetPrimaryThread",
  service: API,
  requestStream: false,
  responseStream: false,
  requestType: hub_pb.GetPrimaryThreadRequest,
  responseType: hub_pb.GetPrimaryThreadReply
};

API.SetPrimaryThread = {
  methodName: "SetPrimaryThread",
  service: API,
  requestStream: false,
  responseStream: false,
  requestType: hub_pb.SetPrimaryThreadRequest,
  responseType: hub_pb.SetPrimaryThreadReply
};
...
APIClient.prototype.getPrimaryThread = function getPrimaryThread(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(API.GetPrimaryThread, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
...
APIClient.prototype.setPrimaryThread = function setPrimaryThread(requestMessage, metadata, callback) {
  if (arguments.length === 2) {
    callback = arguments[1];
  }
  var client = grpc.unary(API.SetPrimaryThread, {
    request: requestMessage,
    host: this.serviceHost,
    metadata: metadata,
    transport: this.options.transport,
